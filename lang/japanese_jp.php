...
$lang = array (
  ...
  "controller_software"         =>  "コントロールソフト",
  "controller_mode"             =>  "コントロールモード",
  // Config Page - MMDVMHost Configuration
  "dmr_mode"                    =>  "DMR モード",
  "d-star_mode"                 =>  "D-Star モード",
  "ysf_mode"                    =>  "YSF モード",
  "p25_mode"                    =>  "P25 モード",
  "nxdn_mode"                   =>  "NXDN モード",
  "mmdvm_display"               =>  "MMDVM ディスプレイタイプ",
  "mode_hangtime"               =>  "モードハングタイム",
  ...
  "dstar_rpt1"                  =>  "RPT1 コールサイン",
  "dstar_rpt2"                  =>  "RPT2 コールサイン",
  "dstar_irc_password"          =>  "ircDDBGateway パスワード",
  "dstar_default_ref"           =>  "ディフォルト　リフレクター",
  "aprs_host"                   =>  "APRS ホスト",
  "dstar_irc_lang"              =>  "ircDDBGateway 言語",
  ...
  "fw_dash"                     =>  "ダッシュボード　アクセス",
  "fw_irc"                      =>  "ircDDBGateway リモート",
  "fw_ssh"                      =>  "SSH アクセス",
